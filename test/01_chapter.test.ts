...
shouldNotThrow(path.join(__dirname, "..", "chapters", "chapter_01", "04_scope.ts"));
shouldNotThrow(path.join(__dirname, "..", "chapters", "chapter_01", "05_spread_operator.ts"));
shouldNotThrow(path.join(__dirname, "..", "chapters", "chapter_01", "06_flow_controls.ts"));
shouldNotThrow(path.join(__dirname, "..", "chapters", "chapter_01", "07_functions.ts"));
shouldNotThrow(path.join(__dirname, "..", "chapters", "chapter_01", "08_classes.ts"));
...
shouldNotThrow(path.join(__dirname, "..", "chapters", "chapter_01", "10_modules.ts"));
